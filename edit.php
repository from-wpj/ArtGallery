		...
		<div class="addwrap">
			<div class="addl fl">
				...
				<form name="publish-form" id="publish-form" action="do_edit.php" method="post"
                  ...
                  <input type="hidden" name="goodsId" value="<?php echo $goodsId;b?>">
                <div class="additem">
                    <label id="for-name">画品名称</label><input type="text" name="name" id="name" placeholder="请输入画品名称" value="<?php echo $goods[0]['goodname'];?>">
                </div>
                <div class="additem">
                ...
                <div class="additem textwrap">
                    <label class="ptop" id="for-des">画品简介</label><textarea id="des" name="des"
                                                                           placeholder="请输入画品简介"><?php echo $goods[0]['des'];?>
                                                                           </textarea>
                </div>
                <div class="additem textwrap">
